...
class AboutMessagePassing < Neo::Koan
  ...
  def test_methods_can_be_invoked_by_sending_the_message
    ...
    #remember here that the method name is a symbol.
  end
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # apparently, send() is performed on the root class object
    # it's a way to be able to not overload one function.
  end
  ...
  # ------------------------------------------------------------------
  # converts a set of parameters into an array, with all of the parameters
