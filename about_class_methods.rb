...
class AboutClassMethods < Neo::Koan
  ...
  #  << is really cool.  so easy to see what's going on.
  #  read a recommendation that the first method is good
  #  when doing a single class method.
  #  the second is great for multiples.
